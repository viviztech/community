...
class ApprovalActionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'approver', 'approver_email', 'level',
...
class ApprovalWorkflowSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'current_level', 'status', 'actions',
            'created_at', 'updated_at', 'escalated_at', 'escalation_count'
        ]
...
class ApprovalActionCreateSerializer(serializers.Serializer):
    ...
    action = serializers.ChoiceField(choices=['approve', 'reject', 'request_info', 'escalate'])
