...
from .serializers import (
    ...
    GeographicAreaSerializer, SisterConcernCreateSerializer,
...
class MemberViewSet(viewsets.ModelViewSet):
    ...
    search_fields = [
        ...
        'organization_name', 'block__name', 'district__name'
    ]
    ...
    def update_scheme_benefits(self, request, pk=None):
        ...
        member = self.get_object()
        serializer = GovernmentSchemeBenefitCreateSerializer(data=request.data, many=True)
        if serializer.is_valid():
