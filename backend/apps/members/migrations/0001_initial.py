...
class Migration(migrations.Migration):
    ...
    operations = [
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            ("SC", "Scheduled Caste"),
                            ("ST", "Scheduled Tribe"),
                            ("CC", "Converted Christians from SC"),
        ...
        migrations.AddIndex(
            model_name="member",
            index=models.Index(
                fields=["block", "district", "state"], name="members_block_i_2ede6f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="member",
            index=models.Index(
                fields=["social_category"], name="members_social__d75f5b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="member",
            index=models.Index(
                fields=["is_doing_business"], name="members_is_doin_9f5ab5_idx"
            ),
        ),
    ]
