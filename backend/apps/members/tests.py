...
class TestMemberViews:
    ...
    def test_retrieve_member_detail(self):
        ...
        user = User.objects.create_user(
            email="detail@example.com", password="testpass123"
        )
        member = Member.objects.create(user=user, organization_name="Detail Org")
    ...
    def test_update_member(self):
        ...
        member = Member.objects.create(user=user, organization_name="Old Org")
...
class TestMemberProfileCompletion:
    ...
    def test_profile_completion_partial(self):
        ...
        user = User.objects.create_user(
            email="partial@example.com", password="testpass123"
        )
        member = Member.objects.create(
            user=user,
