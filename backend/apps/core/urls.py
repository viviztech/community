...
urlpatterns = [
    ...
    path('admin/approvals/', AdminApprovalsListView.as_view(), name='admin-approvals-list'),
    path('admin/revenue/', AdminRevenueStatsView.as_view(), name='admin-revenue-stats'),
    path('admin/geographic-stats/', AdminGeographicStatsView.as_view(), name='admin-geographic-stats'),
]
