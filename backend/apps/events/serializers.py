...
from .models import Event, EventRegistration, Delegate
...
class EventSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'ticket_price', 'max_delegates', 'status',
            'image', 'organizer', 'available_tickets',
...
class DelegateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'name', 'email', 'phone',
            'designation', 'organization', 'is_primary'
        ]
        read_only_fields = ['id']
...
class EventRegistrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'number_of_delegates', 'total_amount', 'payment_status',
            'qr_code', 'ticket_number', 'delegates',
            'created_at', 'updated_at'
        ]
        read_only_fields = [
            'id', 'qr_code', 'ticket_number', 'payment_status',
            'created_at', 'updated_at'
        ]
